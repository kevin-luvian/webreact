...
class ModalAccount extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      filledFavIcon: this.props.favIcon
    };
  ...
  handleShow = (id, name, color, favIcon) => {
    this.setState({
      id: id,
      filledName: name,
      filledColor: color,
      filledFavIcon: favIcon,
      open: true
    });
  };
  ...
  handleFavIconChange = e => {
    this.setState({ filledFavIcon: e.target.value });
  };
  ...
  handleSubmit = () => {
    this.props.onSubmit({
      ...
      favIcon: this.state.filledFavIcon
    });
  };
            ...
            <div className="col-11 col-sm-8 col-md-6 col-xl-5 card mx-auto p-4 my-4">
              ...
              >
                ...
                <TextField
                  ...
                  error={false}
                  label="Icon"
                  value={this.state.filledFavIcon}
